...
export default function PageAnalysisCard({ page, index }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Page Screenshot */}
      {page.screenshot_url ? (
        <div className="relative mb-4 h-72 w-full overflow-hidden rounded-lg border border-slate-200 bg-slate-50 group">
          <Image
          ...
          <button
            ...
            className="absolute top-2 right-2 bg-white/90 hover:bg-white p-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10"
    ...
    {showFullScreenshot && page.screenshot_url && (
      <div 
      ...
      >
        <div className="relative max-w-7xl max-h-[90vh] w-full">
          ...
          {/* Full screenshot */}
          <div className="relative w-full h-full max-h-[85vh] bg-white rounded-lg overflow-auto">
            <Image
              src={page.screenshot_url}
              alt={`Full screenshot of ${page.url}`}
              width={1920}
              height={1080}
